...
public class IsometricView extends View {
    ...
    public interface OnItemClickListener {
        void onClick(@NonNull Isometric.Item item, int iTag);
    }
