...
public class ManualInfoDao {
	...
	private static final RowMapper<DevelopDataInfo> mRowMapper_MessageData = new RowMapper<DevelopDataInfo>() {
		public DevelopDataInfo mapRow(Cursor cursor, int rowNum) {
			...
			// 初始化座垫传感器的值
            String p_init_cushion_A1 = cursor.getString(cursor.getColumnIndex(DBContent.DeviceInfo.Columns.p_init_cushion_A1));
            String p_init_cushion_A2 = cursor.getString(cursor.getColumnIndex(DBContent.DeviceInfo.Columns.p_init_cushion_A2));
            String p_init_cushion_B1 = cursor.getString(cursor.getColumnIndex(DBContent.DeviceInfo.Columns.p_init_cushion_B1));
            String p_init_cushion_B2 = cursor.getString(cursor.getColumnIndex(DBContent.DeviceInfo.Columns.p_init_cushion_B2));
            String p_init_cushion_C1 = cursor.getString(cursor.getColumnIndex(DBContent.DeviceInfo.Columns.p_init_cushion_C1));
            String p_init_cushion_C2 = cursor.getString(cursor.getColumnIndex(DBContent.DeviceInfo.Columns.p_init_cushion_C2));
            command.setP_init_cushion_A1(p_init_cushion_A1);
            command.setP_init_cushion_A2(p_init_cushion_A2);
            command.setP_init_cushion_B1(p_init_cushion_B1);
            command.setP_init_cushion_B2(p_init_cushion_B2);
            command.setP_init_cushion_C1(p_init_cushion_C1);
            command.setP_init_cushion_C2(p_init_cushion_C2);
            ...
            String p_recog_cushion_A1 = cursor.getString(cursor.getColumnIndex(DBContent.DeviceInfo.Columns.p_recog_cushion_A1));
            String p_recog_cushion_A2 = cursor.getString(cursor.getColumnIndex(DBContent.DeviceInfo.Columns.p_recog_cushion_A2));
            String p_recog_cushion_B1 = cursor.getString(cursor.getColumnIndex(DBContent.DeviceInfo.Columns.p_recog_cushion_B1));
            String p_recog_cushion_B2 = cursor.getString(cursor.getColumnIndex(DBContent.DeviceInfo.Columns.p_recog_cushion_B2));
            String p_recog_cushion_C1 = cursor.getString(cursor.getColumnIndex(DBContent.DeviceInfo.Columns.p_recog_cushion_C1));
            String p_recog_cushion_C2 = cursor.getString(cursor.getColumnIndex(DBContent.DeviceInfo.Columns.p_recog_cushion_C2));
            command.setP_recog_cushion_A1(p_recog_cushion_A1);
            command.setP_recog_cushion_A2(p_recog_cushion_A2);
            command.setP_recog_cushion_B1(p_recog_cushion_B1);
            command.setP_recog_cushion_B2(p_recog_cushion_B2);
            command.setP_recog_cushion_C1(p_recog_cushion_C1);
            command.setP_recog_cushion_C2(p_recog_cushion_C2);
            ...
            // 信噪比
            String snr = cursor.getString(cursor.getColumnIndex(DBContent.DeviceInfo.Columns.Snr));
		...
		private ContentValues makeValues(DevelopDataInfo temp) {
			...
			initialValues.put(DBContent.DeviceInfo.Columns.p_init_cushion_A1, temp.getP_init_cushion_A1());
			initialValues.put(DBContent.DeviceInfo.Columns.p_init_cushion_A2, temp.getP_init_cushion_A2());
			initialValues.put(DBContent.DeviceInfo.Columns.p_init_cushion_B1, temp.getP_init_cushion_B1());
			initialValues.put(DBContent.DeviceInfo.Columns.p_init_cushion_B2, temp.getP_init_cushion_B2());
			initialValues.put(DBContent.DeviceInfo.Columns.p_init_cushion_C1, temp.getP_init_cushion_C1());
			initialValues.put(DBContent.DeviceInfo.Columns.p_init_cushion_C2, temp.getP_init_cushion_C2());
            ...
            initialValues.put(DBContent.DeviceInfo.Columns.p_recog_cushion_A1, temp.getP_recog_cushion_A1());
            initialValues.put(DBContent.DeviceInfo.Columns.p_recog_cushion_A2, temp.getP_recog_cushion_A2());
            initialValues.put(DBContent.DeviceInfo.Columns.p_recog_cushion_B1, temp.getP_recog_cushion_B1());
            initialValues.put(DBContent.DeviceInfo.Columns.p_recog_cushion_B2, temp.getP_recog_cushion_B2());
            initialValues.put(DBContent.DeviceInfo.Columns.p_recog_cushion_C1, temp.getP_recog_cushion_C1());
            initialValues.put(DBContent.DeviceInfo.Columns.p_recog_cushion_C2, temp.getP_recog_cushion_C2());
			...
			initialValues.put(DBContent.DeviceInfo.Columns.Snr, temp.getSnr());
